...
BOT_TOKEN = environ.get('BOT_TOKEN', "7130777996:AAHUe8Y6wum7lAsS-QAEE_bKW7HB_T9Q1So")

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 30))
USE_CAPTION_FILTER = bool(environ.get('USE_CAPTION_FILTER', False))
PICS = (environ.get('PICS', 'https://telegra.ph/file/0a00a103abd90ddffbe9f.jpg')).split()
...
# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001525168158'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Bkm_Botz_Support')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001890815456')).split()]
